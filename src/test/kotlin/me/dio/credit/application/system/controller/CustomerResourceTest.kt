...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("456135"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da Cami, 120"))
    ...
    private fun builderCustomerDto(
        ...
        zipCode: String = "456135",
        street: String = "Rua da Cami, 120",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
